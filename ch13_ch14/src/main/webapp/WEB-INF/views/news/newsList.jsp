...
<body>
	<div class="container w-75 mt-5 mx-auto">
		...
		<button class="btn btn-outline-info mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#addForm" area-expanded="false" aria-controls="addForm">뉴스 등록</button>
